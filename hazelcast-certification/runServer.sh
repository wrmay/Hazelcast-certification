...
java -Xms8g -Xmx8g -Xmn4g -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:+UseCompressedOops -classpath  target/hazelcast-certification-1.0-SNAPSHOT.jar com.hazelcast.certification.server.FraudDetectionServer
