...
java -Xms3g -Xmx4g -XX:+UseParallelOldGC -XX:+UseParallelGC -XX:+UseCompressedOops -classpath "../nfs/app/certification/lib/*":../nfs/app/certification/resources com.hazelcast.certification.server.FraudDetectionServer
